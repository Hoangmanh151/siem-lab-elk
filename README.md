...
## 📊 Dashboard
1/Failed SSH login attempts over time → spike detected during attack
...
2/Top source IPs → attacker IP identified
...
3/Authentication success vs failure → abnormal ratio during attack window
